...
def validate_location_params(
    location: Optional[str] = Query(None, description="Location name (e.g., 'London', 'New York')"),
    lat: Optional[float] = Query(None, description="Latitude (-90 to 90)", ge=-90, le=90),
    lon: Optional[float] = Query(None, description="Longitude (-180 to 180)", ge=-180, le=180)
