...
from app.models.weather import WeatherResponse, WeatherMessage, Location, CurrentWeather, HourlyForecast, Alert, WeatherCondition
...
class WeatherService:
    ...
    async def get_weather_forecast(self, location: Optional[str] = None, lat: Optional[float] = None, lon: Optional[float] = None) -> WeatherResponse:
        """
    ...
    def _build_query(self, location: Optional[str], lat: Optional[float], lon: Optional[float]) -> str:
        ...
        try:
            ...
            weather_response = WeatherResponse(
                ...
                message=WeatherMessage(
                    ...
                    alerts=self._transform_alerts(data.get("alerts", {}).get("alert", [])),
    ...
    def _get_filtered_forecast(self, data: dict, current_time: datetime) -> list:
        ...
        try:
            ...
            tomorrow_hours = data["forecast"]["forecastday"][1]["hour"] if len(data["forecast"]["forecastday"]) > 1 else []
